...
AR_STATIC_ARGS = cr
NAME = Video::Manip
DISTNAME = Video-Manip
NAME_SYM = Video_Manip
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
...
TO_INST_PM = lib/Cool.pm \
	lib/Event.pm \
	lib/Event/Manual.pm \
	lib/FindEvent.pm \
	lib/FindEvent/Manual.pm \
	lib/Video/Manip.pm

PM_TO_BLIB = lib/Video/Manip.pm \
	blib/lib/Video/Manip.pm \
	lib/Cool.pm \
	blib/lib/Cool.pm \
	lib/FindEvent.pm \
	blib/lib/FindEvent.pm \
	lib/Event/Manual.pm \
	blib/lib/Event/Manual.pm \
	lib/FindEvent/Manual.pm \
	blib/lib/FindEvent/Manual.pm \
	lib/Event.pm \
	blib/lib/Event.pm
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Video/Manip.pm blib/lib/Cool.pm blib/lib/FindEvent.pm
	rm -f blib/lib/Event/Manual.pm blib/lib/FindEvent/Manual.pm blib/lib/Event.pm
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{lib/Video/Manip.pm blib/lib/Video/Manip.pm lib/Cool.pm blib/lib/Cool.pm lib/FindEvent.pm blib/lib/FindEvent.pm lib/Event/Manual.pm blib/lib/Event/Manual.pm lib/Event.pm blib/lib/Event.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{lib/FindEvent/Manual.pm blib/lib/FindEvent/Manual.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
